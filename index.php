    						...
    						<div class="art-content-layout-row">
                            	<div id="dt1" class="art-layout-cell layout-item-0" style="width: 100%" >
                            		<div class="form-inline">
										แต้มสะสมลูกค้าเครดิต ตั้งแต่
                                        <select name="syear" id="syear" style="width:300px;">
											<option value="00">---เลือกช่วงวันที่---</option>
                                            <!--<option value="59">1 พฤศจิกายน 2558 - 31 ตุลาคม 2559</option>
                                            <option value="60">1 พฤศจิกายน 2559 - 31 ตุลาคม 2560</option>-->
                                            <option value="61">1 พฤศจิกายน 2560 - 31 ตุลาคม 2561</option>
																						<option value="62">1 พฤศจิกายน 2561 - 31 ตุลาคม 2562</option>
                                        </select>
                                        <input name="b_syear" type="button" value="ดูข้อมูลแต้มสะสม" class="btn-info" onClick="javascirpt:loaddatatable();">
                                    </div>
                            <!-- ///// --->
